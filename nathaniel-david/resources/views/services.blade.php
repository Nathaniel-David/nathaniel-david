      ...
      <ul class="cs-destination-listing destination-fancy">
         <li class="facny-view-expand">     
            <div class="inner-holder">
                <div class="cs-media">
                    <figure>
                        <img src="/img/pexels-photo.jpg" class="attachment-traveladvisor_var_media_6 size-traveladvisor_var_media_6 wp-post-image"   />                        
                    <figcaption>

                <div class="cs-text cs-location">
                    <div class="cs-location-sec">
                            <h3><a href="#">Digital Planning</a></h3><br>
                        </div>
                    </div>
                    </figcaption>
                    </figure>
                ...
                <div class="over-preview">
                    <div class="cs-text">
                        <div class="cs-location-sec">
                            <h3><a href="#">Digital Planning</a></h3>
                        </div>
                       <p>Develop your digital presence with SEO, Digital Marketing, and accurate tracking. Best practices will be used to ensure your site is compliant with Google and optimized so potential customers can find you. Get set up with Google Analytics, Facebook Marketing, and clean content to keep your business modern and competitive.</p>
                    </div>
                </div>
            ...
            <div class="inner-holder">
                <div class="cs-media">
          <figure>
            <img src="/img/pexels-photo2.jpg" class="attachment-traveladvisor_var_media_6 size-traveladvisor_var_media_6 wp-post-image" />                       
            <figcaption>
